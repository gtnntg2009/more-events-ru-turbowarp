...
// Translate By: gtnntg <https://scratch.mit.edu/users/gtnntg/>
...
(function (Scratch) {
    ...
    const beforeSave = () =>
      new Promise((resolve) => {
        const threads = vm.runtime.startHats("lmsMoreEventsru_beforeSave");
    ...
    const afterSave = () => {
      ...
      vm.runtime.once("BEFORE_EXECUTE", () => {
        vm.runtime.startHats("lmsMoreEventsru_afterSave");
      });
    };
    ...
    class MoreEvents {
      constructor() {
        ...
        runtime.on("BEFORE_EXECUTE", () => {
          ...
          runtime.startHats("lmsMoreEventsru_forever");
          runtime.startHats("lmsMoreEventsru_whileTrueFalse");
          runtime.startHats("lmsMoreEventsru_whenValueChanged");
          runtime.startHats("lmsMoreEventsru_everyDuration");
          runtime.startHats("lmsMoreEventsru_whileKeyPressed");
        });
        ...
        runtime.on("PROJECT_STOP_ALL", () => {
          ...
          if (runtime.shouldExecuteStopClicked)
            queueMicrotask(() =>
              runtime.startHats("lmsMoreEventsru_whenStopClicked")
            );
        });
        ...
        return {
          ...
          blocks: [
  ...
  
            {
              ...
              text: "когда [CONDITION] становится [STATE]",
            ...
            },
            {
              ...
              blockType: Scratch.BlockType.HAT,
              text: "пока [CONDITION] является [STATE]",
              isEdgeActivated: false,
              arguments: {
                CONDITION: {
                  type: Scratch.ArgumentType.BOOLEAN,
  ...
  
            {
              ...
              blockType: Scratch.BlockType.HAT,
              text: "когда [KEY_OPTION] ключ [ACTION]",
              isEdgeActivated: true,
              arguments: {
                KEY_OPTION: {
                  type: Scratch.ArgumentType.STRING,
            ...
            },
            {
              ...
              blockType: Scratch.BlockType.HAT,
              text: "пока клавиша [KEY_OPTION] нажата",
              isEdgeActivated: false,
              arguments: {
                KEY_OPTION: {
                  type: Scratch.ArgumentType.STRING,
  ...
  
            {
              ...
              text: "распространить сообщение [BROADCAST_OPTION] на [TARGET]",
              arguments: {
                BROADCAST_OPTION: {
                  type: null,
                },
            ...
            },
            {
              ...
              blockType: Scratch.BlockType.COMMAND,
              text: "распространить сообщение [BROADCAST_OPTION] на [TARGET] и ждать",
              arguments: {
                BROADCAST_OPTION: {
                  type: null,
                },
  ...
  
            {
              ...
              blockType: Scratch.BlockType.COMMAND,
              text: "распространить сообщение [BROADCAST_OPTION] с данными [DATA]",
              arguments: {
                BROADCAST_OPTION: {
                  type: null,
                },
            ...
            },
            {
              ...
              blockType: Scratch.BlockType.COMMAND,
              text: "распространить сообщение [BROADCAST_OPTION] с данными [DATA] и ждать",
              arguments: {
                BROADCAST_OPTION: {
                  type: null,
                },
            ...
            },
            {
              ...
              xml: '<block type="lmsMoreEventsru_broadcastToTarget"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="TARGET"><shadow type="lmsMoreEventsru_menu_targetMenu"></shadow></value></block><block type="lmsMoreEventsru_broadcastToTargetAndWait"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="TARGET"><shadow type="lmsMoreEventsru_menu_targetMenu"></shadow></value></block><sep gap="36"/><block type="lmsMoreEventsru_broadcastData"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="DATA"><shadow type="text"></shadow></value></block><block type="lmsMoreEventsru_broadcastDataAndWait"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="DATA"><shadow type="text"></shadow></value></block>',
            },
            {
              opcode: "receivedData",
  ...
  
            {
              ...
              blockType: Scratch.BlockType.COMMAND,
              text: "распространить [BROADCAST_OPTION] на [TARGET] с данными [DATA]",
            ...
            },
            {
              ...
              blockType: Scratch.BlockType.COMMAND,
              text: "распространить [BROADCAST_OPTION] на [TARGET] с данными [DATA] и ждать",
            ...
            {
              blockType: Scratch.BlockType.XML,
              xml: '<block type="lmsMoreEventsru_broadcastDataToTarget"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="TARGET"><shadow type="lmsMoreEventsru_menu_targetMenu"></shadow></value><value name="DATA"><shadow type="text"></shadow></value></block><block type="lmsMoreEventsru_broadcastDataToTargetAndWait"><value name="BROADCAST_OPTION"><shadow type="event_broadcast_menu"></shadow></value><value name="TARGET"><shadow type="lmsMoreEventsru_menu_targetMenu"></shadow></value><value name="DATA"><shadow type="text"></shadow></value></block>',
            },
            "---",
            {
              blockType: Scratch.BlockType.EVENT,
              opcode: "beforeSave",
              text: "перед сохранением проекта",
